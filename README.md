...
##
Este repositório contem "MiniMundos" feitos em aula e em trabalhos pedidos pela professora. Onde, nesses minimundos são anotados os
requisitos funcionais, os requisitos não funcionais, e as regras de negócios do sistema, a partir do texto que nós é dado.
...
- Requisitos não funcionais:
  ...
  deve oferecer, como por exemplo:
    ...
    - Requisitos externos: éticos, legais, segurança e privacidade
  ```
- Regras de Negócios:
  ```
